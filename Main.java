...
public class Main {
    ...
    // MAIN FUNCTION THAT CONTINOUSLY SHOW OPTIONS
    static void main_menu(){
        ...
        System.out.println();
        System.out.println("1].ADD SHOWROOMS \t\t\t 2].ADD EMPLOYES \t\t\t\t 3].ADD CARS");
        System.out.println();
        System.out.println("4].GET SHOWROOMS \t\t\t 5].GET EMPLOYES \t\t\t\t 6].GET CARS");
        System.out.println();
